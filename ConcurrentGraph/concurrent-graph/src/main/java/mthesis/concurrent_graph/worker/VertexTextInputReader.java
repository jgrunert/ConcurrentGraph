...
/**
 * Reads input from file with standard format
 * 	Vertex0,VertexValue0|Edge1Neighbor,Edge1Value;Edge2Neighbor,Edge2Value
 * 	Vertex1...
 * 
 * @author Jonas Grunert
 */
public class VertexTextInputReader<V extends BaseWritable, E extends BaseWritable, M extends BaseWritable>  {
	...
	public List<AbstractVertex<V, E, M>> getVertices(List<String> partitions, JobConfiguration<V, E, M> jobConfig,
		...
		final List<AbstractVertex<V, E, M>> vertices = new ArrayList<>();
		...
		for(final String partition : partitions) {
			try (BufferedReader br = new BufferedReader(new FileReader(partition))) {
				...
				while ((line = br.readLine()) != null) {
					...
					final AbstractVertex<V, E, M> vertex = vertexFactory.newInstance(vertexId, vertexMessageSender);
