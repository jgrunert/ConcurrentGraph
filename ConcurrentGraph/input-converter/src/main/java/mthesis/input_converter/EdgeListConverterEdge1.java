 ...
 *
 * Similar to EdgeListConverter but sets edge values to 1.
 *
 ...
 *
 */
public class EdgeListConverterEdge1 {

	protected static final Logger logger = LoggerFactory.getLogger(EdgeListConverterEdge1.class);
	...
	public static void main(String[] args) throws Exception {
		...
		try (BufferedReader inReader = new BufferedReader(new FileReader(inputFile))) {
			...
			while ((line = inReader.readLine()) != null) {
				...
				vertexEdges.add(new Edge(Integer.parseInt(lineSplit[1]), "1"));
